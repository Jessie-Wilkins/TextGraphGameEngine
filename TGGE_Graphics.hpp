...
class TGGE_Graphics {
    ...
    private:
        ...
        string addCharacterToFirstLine(string str_graph, int location_of_line_break, int horizontal_location, char letter);
        string addCharacterToNewLine(string str_graph, int horizontal_location, char letter);
        string addCharacterBetweenFirstAndLastLine(string str_graph, int vertical_location, char letter, int location_of_line_break, int horizontal_location);
